...
add_action('wp_ajax_svb_monobank_debug_status', 'svb_monobank_debug_status');
add_action('wp_ajax_nopriv_svb_monobank_debug_status', 'svb_monobank_debug_status');
add_action('init', 'svb_handle_monobank_webhook', 0);
